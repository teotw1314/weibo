package com.skyland.sky_base.ui;
...
import com.skyland.sky_base.R;
import com.skyland.sky_base.utils.CheckOsUtil;
...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     */
    protected void setImmersiveStatusBar(boolean fontIconDark, @ColorRes int statusBarPlaceColor) {
        ...
        if (fontIconDark) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M
                ...
                if (ContextCompat.getColor(this, statusBarPlaceColor) == ContextCompat.getColor(this, android.R.color.white)) {
                    statusBarPlaceColor = R.color.lib_base_colorStatusBarGrey;
                }
            }
        }
        setStatusBarPlaceColor(statusBarPlaceColor);
    }
    private void setStatusBarPlaceColor(@ColorRes int statusColor) {
        if (stateBarPlace != null) {
            stateBarPlace.setBackgroundColor(ContextCompat.getColor(this, statusColor));
        }
    }
